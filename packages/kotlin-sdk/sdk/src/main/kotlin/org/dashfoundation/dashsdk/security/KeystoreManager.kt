...
open class KeystoreManager(
    ...
    /**
     * SHA-256 of the current [keysAlias] RSA public key, hex-encoded. Callers
     ...
     */
    open fun keysAliasFingerprint(): String =
        MessageDigest.getInstance("SHA-256").digest(keysPublicKey(keysAlias).encoded)
