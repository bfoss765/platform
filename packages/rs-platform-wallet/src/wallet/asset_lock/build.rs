...
mod tests {
    ...
    /// EXPERIMENT guard (integration branch): the vendored key-wallet
    /// CoinJoin gap is forced to 30 to isolate the #846/#873 committed-range
    /// re-scan fix. This asserts the effective constant the AAR is built
    /// against is really 30 (upstream default is 100, rust-dashcore#868).
    #[test]
